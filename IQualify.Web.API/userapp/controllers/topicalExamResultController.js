...
(function (module) {
    ...
    var topicalExamResultController = function ($scope, $stateParams, toastr, result) {
        ...
        $scope.chartDataSource = {
            chart: {
                caption: "Result of current topical exam",
                startingangle: "120",
                showlabels: "1",
                showlegend: "1",
        ...
        var init = function () {
            ...
            result.getTopicalExamResult(resultId).then(onResult, onResultError);
        }
    ...
    topicalExamResultController.$inject = ["$scope", "$stateParams", "toastr", "result"];
    module.controller("topicalExamResultController", topicalExamResultController);
