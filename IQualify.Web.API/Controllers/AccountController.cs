...
using IQualify.Web.API.Providers;
using IQualify.Web.API.Results;
...
namespace IQualify.Web.API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private async Task SendConfirmationEmail(string userId)
        {
            ...
            var callbackUrl = string.Format("http://localhost:5445/#/confirm-email/{0}/{1}", userId, HttpUtility.UrlEncode(code).Replace("%2f", "%252F"));
